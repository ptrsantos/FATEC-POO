...
public class FrmTabelaClientePedido extends javax.swing.JFrame {
    ...
    private void jTableClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableClienteMouseClicked
       ...
       /* Cliente cliente = new Cliente();
        ...
        if(indice >= 0 && indice < cl.listarCliente().size()){
            cliente.setIdCliente(cl.listarCliente().get(indice).getIdCliente());
            cliente.setNomeDoCliente(cl.listarCliente().get(indice).getNomeDoCliente());
            cliente.setRg(cl.listarCliente().get(indice).getRg());
            cliente.setEmail(cl.listarCliente().get(indice).getEmail());
            cliente.setTelefone(cl.listarCliente().get(indice).getTelefone());
        }*/
        fp.selecionaItemBox(indice);
        fp.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTabelaClientePedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTabelaClientePedido().setVisible(true);
            }
        });
    }
